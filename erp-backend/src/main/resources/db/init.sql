...
-- customer 表新增字段
-- ALTER TABLE customer ADD COLUMN add_friend_time DATETIME DEFAULT NULL COMMENT '加粉时间' AFTER email;
-- ALTER TABLE customer ADD COLUMN birthday VARCHAR(5) DEFAULT NULL COMMENT '生日 MM-DD' AFTER add_friend_time;
-- ALTER TABLE customer ADD COLUMN wechat_account VARCHAR(100) DEFAULT NULL COMMENT '微信号' AFTER birthday;
...
-- sales_order 新增字段（如果是从旧表迁移）
ALTER TABLE sales_order
    ADD COLUMN sales_account_id BIGINT DEFAULT NULL COMMENT '销售账户ID',
    ADD INDEX idx_sales_account_id (sales_account_id);
...
ALTER TABLE sales_order
    ADD COLUMN payment_channel_type_id BIGINT DEFAULT NULL COMMENT '收款渠道ID',
    ADD COLUMN payment_amount DECIMAL(12,2) NOT NULL DEFAULT 0.00 COMMENT '收款金额',
    ADD INDEX idx_payment_channel_type_id (payment_channel_type_id);
